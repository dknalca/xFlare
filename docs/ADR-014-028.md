...
**Consecuencias.**
- ✅ Scroll suave y autopista/tira siempre sincronizadas.
- ✅ Onda legible y con informacion de frecuencia de un vistazo.
- ✅ Todo XFApp, nada sellado, sin dependencias (biquads a mano).
